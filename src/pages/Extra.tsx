...
const faqs = [
  ...
  { q:'Como configurar a URL da API?', a:'Crie um arquivo .env na raiz do projeto com VITE_API_URL=http://localhost:8080. Essa URL aponta para a API Java Quarkus do projeto OrbitCast na sua area de trabalho.' },
  ...
  { q:'A API Java precisa estar rodando?', a:'Sim. Abra a pasta OrbitCast da area de trabalho e inicie o backend com mvn quarkus:dev. Depois rode o front-end normalmente com npm run dev.' },
];
