...
const faqs = [
  ...
  { q:'Como configurar a URL da API?', a:'Crie um arquivo .env na raiz do projeto com VITE_API_URL=https://sua-api.com. Para a entrega, o front já consome a API publicada na nuvem.' },
  ...
  { q:'A API Java precisa estar rodando?', a:'Sim. O front-end consome a API REST Java publicada remotamente, garantindo integração entre as disciplinas.' },
];
